...
public class testDatabaseKeyDrafted
{	//if one of the methods you're using in MAIN throws an exception, you must declare main to throw an exception as well
	public static void main(String [] args){
		...
		try 
		{	
			new testDatabaseKeyDrafted(key);		
		} 
		catch (Exception e)
		{
	...
	private testDatabaseKeyDrafted(DatabaseKey thisKey) throws Exception{
		System.out.println(thisKey.isDraft());
	}	
