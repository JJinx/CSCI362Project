...
public class testFieldBasicsTag
{	//if one of the methods you're using in MAIN throws an exception, you must declare main to throw an exception as well
	public static void main(String [] args) {
		...
		FieldSpec spec = FieldSpec.createCustomField(args[0], "label", new FieldTypeNormal());  //NOTE: the strings here are NOT hard coded by us because this is hor a FieldSpec is initialized the code
		...
		*/
		try{
			new testFieldBasicsTag(spec,mf, args[0]);
		}
		catch(Exception e){
			System.out.println(e);
		}
	}
	public testFieldBasicsTag(FieldSpec thisSpec, MartusField thisField, String input){
		System.out.println(thisSpec.getTag() == thisField.getTag());
	}
